...
[From the dashdiff github repo](https://github.com/dashdiffpay/dashdiff/blob/master/doc/masternode_conf.md)
...
```
mn01 127.0.0.1:10332 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0
mn02 127.0.0.2:10332 93WaAb3htPJEV8E9aQcN23Jt97bPex7YvWfgMDTUdWJvzmrMqey aa9f1034d973377a5e733272c3d0eced1de22555ad45d6b24abadff8087948d4 0
```

## Update dashdiff.conf on server

If you generated a new masternode private key, you will need to update the remote `dashdiff.conf` files.

Shut down the daemon and then edit the file.

```nano .dashdiffcore/dashdiff.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `dashdiff.conf` file.
...
```dashdiff-cli getinfo```

and comparing with the official explorer at https://explorer.dashdiff.org/chain/Dashdiff
...
```
dashdiff-cli masternode status
{
...
Search your Masternodes on https://dashdiffninja.pl/masternodes.html
