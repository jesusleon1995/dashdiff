...
Dashdiff Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 10332.
...
However, in open source software such as Dashdiff Core, where everyone uses
...
pay attention to for reviewers of Dashdiff Core code.

General Dashdiff Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Dashdiff Core uses tinyformat, which is type safe. Leave them out to avoid confusion
