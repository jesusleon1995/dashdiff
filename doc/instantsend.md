...
This mechanism has been integrated into Bitcore-Node-Dashdiff which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dashdiffpay/insight-api-dashdiff#web-socket-api](https://github.com/dashdiffpay/insight-api-dashdiff#web-socket-api)
* API: [https://github.com/dashdiffpay/insight-api-dashdiff#instantsend-transactions](https://github.com/dashdiffpay/insight-api-dashdiff#instantsend-transactions)
...
By default, the Dashdiff Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dashdiff Core daemon:
