...
Only requiring some minor changes is dashdiff.cpp.
...
Changes to dashdiff.cpp
----------------------
dashdiff.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
