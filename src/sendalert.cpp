...
2. run dashdiffd with -printalert or -sendalert like this:
   /path/to/dashdiffd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.dashdiff.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Dashdiff Core:0.12.0.58/"));
