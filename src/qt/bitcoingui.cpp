    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Dashdiff Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dashdiff address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dashdiff: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Dashdiff Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dashdiff Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dashdiff Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dashdiff addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dashdiff addresses"));
    ...
    openAction->setStatusTip(tr("Open a dashdiff: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dashdiff Core help message to get a list with possible Dashdiff Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dashdiff Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dashdiff network", "", count));
    } else {
...
{
    QString strTitle = tr("Dashdiff Core"); // default title
