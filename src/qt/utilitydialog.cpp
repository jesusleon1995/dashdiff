    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Dashdiff Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Dashdiff Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dashdiff-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Dashdiff in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://dashdiffpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://dashdiffpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Dashdiff Core is shutting down...") + "<br /><br />" +
