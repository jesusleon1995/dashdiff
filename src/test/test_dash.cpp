...
#define BOOST_TEST_MODULE Dashdiff Test Suite

#include "test_dashdiff.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_dashdiff_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
