...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Dashdiff Core dashdiff-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dashdiff-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dashdiff transaction") + "\n" +
              "  dashdiff-tx [options] -create [commands]   " + _("Create hex-encoded dashdiff transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dashdiff transaction
