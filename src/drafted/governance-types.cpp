...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DashdiffNetwork") type = DashdiffNetwork;
    if(strType == "DashdiffNetworkVariable") type = DashdiffNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DashdiffNetwork) s = "DashdiffNetwork";
    if(type == DashdiffNetworkVariable) s = "DashdiffNetworkVariable";
